...
DEFAULT_BUILD_VERSION="1.45.2"
BUILD_WITH_CARGO="1.47.0"
...
cp $TOOLCHAIN_PATH/bin/cargo $TOOLCHAIN_PATH/bin/cargo_bak

[ -e ./target/release/cargo ] && echo "copying ./target/release/cargo" && cp ./target/release/cargo $TOOLCHAIN_PATH/bin/cargo
